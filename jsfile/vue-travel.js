export default {
    data() {
        return {
            travel_intro: "Traveling around the world has always been my dream! Although it's still far away from realization, when I look back to those days, I have already been to so many places!",
            travel: [
                {
                    defaultSrc: "../Hobby/travel/image/hiking_in_Hawaii_400x300.jpg",
                    src1: "../Hobby/travel/image/hiking_in_Hawaii_400x300.jpg",
                    src2: "../Hobby/travel/image/hikingHawaii2_400x300.jpg",
                    alt: "hiking in Hawaii",
                ...
                {
                    defaultSrc: "../Hobby/travel/image/death_valley_400x300.jpg",
                    src1: "../Hobby/travel/image/death_valley_400x300.jpg",
